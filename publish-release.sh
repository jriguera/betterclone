...
RELEASE="betterclone"
VERSION=${VERSION:-}
DESCRIPTION="Backup/Restore management tool for btrfs subvolume filesystems"
GITHUB_REPO="jriguera/betterclone"

###

BUILDEB="dpkg-buildpackage -rfakeroot -us -uc -d"
JQ="jq"
CURL="curl -s"
SHA1="sha1sum -b"
